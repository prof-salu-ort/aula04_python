'''
8. Fazer um programa que dado um valor inteiro m calcule o menor número de notas 
de Real em que este número pode ser decomposto. Lembre-se que as notas existentes 
são 1, 2, 5, 10, 20, 50 e 100. A Saída do programa deve ser o valor da entrada 
seguido de uma lista de notas correspondentes. 
